...
int main(int argc, char * argv[]){ // This code only calculates the first eigenvalue of the arbitrarely large matrix. Made to call and time from the Makefile.
