...
void vector_print(const char* s, gsl_vector* v){ // This function will print the input vector
    printf("%s\n",s);
  ...
  void matrix_print(const char* s, gsl_matrix* A){ // This function will print the input matrix
    printf("%s\n",s);
