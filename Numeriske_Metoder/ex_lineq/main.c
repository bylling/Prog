...
int main(){
fprintf(stdout, "Exercise A.1 is started\n");
...
fprintf(stdout, "Exercise A.2 is started\n");
...
// Exercise B
fprintf(stdout, "Exercise B is started\n");
...
// Exercise C
fprintf(stdout, "Exercise C is started\n");
...
fprintf(stdout, "This concludes all three exercises.\n");
