...
matrix_print("A_glk",A_glk);
matrix_print("A_inv",A_inv);
...
int inverse_iteration(gsl_matrix* A, gsl_vector* e, gsl_vector* V,double s,double update){ // Function for solution of the nearest eigenvalue near the guess "s" of a matrix using shifted inverse iteration by QR-decompostion and a user-defined eigenvalue-estimate update pattern.
